...
class RobotAPI:
    ...
    def navigate(
        ...
        ''' Send a NavigateToPose goal to Nav2 using the map frame. '''
        try:
            if self._nav_client is None:
                return False
            ...
            # Frame selection: prefer map_name from RMF if provided
            frame = 'map'
            ...
            # Reset completion flag; will be set True on result callback
